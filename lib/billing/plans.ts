...
export const MANAGED_PLANS: SynaptiReachPlan[] = [
  {
    ...
    sms: "100/mo",
    contacts: "500",
    agents: "1 lightweight AI review check",
    workflowRuns: "500/mo",
...
export const TRIAL_PATHS = [
  {
    ...
    description: "Full software access for 14 days with hard free caps for SynaptiReach-managed AI, email, SMS, contacts, workflows, and AI review checks.",
    cardRequired: true,
...
export const TRIAL_PLANS = [
  {
    ...
    agents: `${MANAGED_TRIAL_CAPS.agentRuns} AI review checks`,
