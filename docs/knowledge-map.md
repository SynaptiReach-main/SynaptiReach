...
- [[SynaptiReach Onboarding]] contains a CRM setup summary in existing settings metadata for admin/onboarding review without creating fake CRM records.
...
- [[SynaptiReach Onboarding]] contains manual service/product rows that map into existing settings metadata without claiming service-menu extraction success.
