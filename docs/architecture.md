...
`crm_settings.metadata` is the CRM-population bridge for onboarding defaults: service areas/hours, main customer type, primary service/product categories, top services/products, common customer problems/questions/objections, emergency/priority rules, booking/quote/review notes, pipeline defaults, stale lead/deal thresholds, follow-up timing, owner assignment preferences, appointment types, reminder timing, task defaults, analytics goals/baselines, communication style, AI risk/draft preferences, calendar setup, marketing setup, retargeting/review-request timing, and workflow draft preferences. These values configure the real workspace and recommendations; onboarding does not generate fake CRM activity.
