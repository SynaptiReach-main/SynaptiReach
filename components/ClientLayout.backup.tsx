  ...
  return (
    <canvas
      ...
      style={{
        ...
        zIndex: 10,
        pointerEvents: "none",
        WebkitMaskImage: "linear-gradient(to bottom right, rgba(0,0,0,0.1) 0%, rgba(0,0,0,1) 100%)",
        maskImage:        "linear-gradient(to bottom right, rgba(0,0,0,0.1) 0%, rgba(0,0,0,1) 100%)",
      }}
    />
  )
}
  ...
  return (
    <div className="min-h-screen text-white bg-[#0A0F1F] relative overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: `
            radial-gradient(rgba(0, 229, 255, 0.35) 0.8px, transparent 0.8px),
            linear-gradient(to right, rgba(0, 229, 255, 0.08) 0.5px, transparent 0.5px),
            linear-gradient(to bottom, rgba(0, 229, 255, 0.08) 0.5px, transparent 0.5px)
          `,
